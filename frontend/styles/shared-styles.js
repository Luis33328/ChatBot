...
<custom-style>
  <style>
    html {
      overflow:hidden;
      --lumo-base-color: #1B2838;
      --lumo-shade-90pct: #D3D3D3;
      --lumo-shade-10pct: #5F656D;
      --lumo-primary-text-color: #C6C6C6;
    }
  ...
  <template>
    <style include="vaadin-chart-default-theme">
      ...
      .highcharts-background {
        fill: #1B2838;/*var(--lumo-base-color);*/
      }
      .highcharts-title {
        fill: #1B2838; /*var(--lumo-header-text-color);*/
      ...
      .highcharts-axis-labels {
        fill: #1B2838; /*var(--lumo-secondary-text-color);*/
      }
      ...
      .highcharts-column-series rect.highcharts-point {
        stroke: #1B2838; /*var(--lumo-base-color);*/
      }
    </style>
  </template>
</dom-module>`;
